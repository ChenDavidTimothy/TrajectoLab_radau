...
class Problem:
    ...
    def add_event_constraint(self, constraint_func):
        self._event_constraints.append(constraint_func)
        return self
    
    # Internal methods to convert to/from named and vectorized forms
    def _convert_to_legacy_problem(self):
        ...
        vectorized_event_constraints = self._create_vectorized_event_constraints()
        ...
        return OptimalControlProblem(
            ...
            event_constraints_function=vectorized_event_constraints if self._event_constraints else None,
