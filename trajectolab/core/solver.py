...
# Import problem definition types from .problem instead of defining them inline
from .problem import ProblemDefinition, Solution

# Import basis functions from new location
from . import basis as rpm_basis  # Ensure this import works
