...
def animate_car_drift_dynamics(solution, save_filename="car_drift_animation.mp4"):
    """Animate obstacle-free bicycle model dynamics with enhanced visualization."""
    ...
    ax_main.set_title("Dynamic Bicycle Model - Obstacle Free")
    ...
    # Define vehicle radius from the problem
    vehicle_radius = 1.5
...
if __name__ == "__main__":
    ...
    if solution.status["success"]:
        print("Creating enhanced animation for obstacle-free bicycle model...")

        # Save mp4 in the same directory as this script
        script_dir = Path(__file__).parent
        output_file = script_dir / "car_drift_animation.mp4"

        anim = animate_car_drift_dynamics(solution, str(output_file))
