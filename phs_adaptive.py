...
from rpm_solver import solve_single_phase_radau_collocation, Solution, ProblemDefinition
...
def h_reduce_intervals(
    ...
    adaptive_refinement_parameters_for_h_reduction: AdaptiveParams, state_component_error_normalization_factors_gamma: np.ndarray, # Pre-calculated
...
def run_phs_adaptive_mesh_refinement(
    ...
    for current_adaptive_refinement_iteration_number in range(max_allowable_adaptive_refinement_iterations):
        ...
        most_recent_successful_optimal_control_solution_details["global_mesh_nodes_at_solve_time"] = np.copy(current_iteration_global_normalized_mesh_nodes_array) # For initial_guess_data propagation
